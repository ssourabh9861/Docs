...
2. **Next writing turn:** `04-messaging-streaming` (Pulsar/Storm/CDC — the heart of
   your platform story). Say "next".
3. Then: `02-databases`, `14-distributed-transactions`, `03-caching`,
